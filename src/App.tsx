      ...
      <header className="justify-center items-center text-white">
        ...
        <div className="flex flex-col mt-4 items-center text-center">
          ...
          <input
            ...
            className="rounded-xl p-2 w-full md:w-[427px] border text-zinc-700 truncate text-center text-sm sm:text-lg bg-zinc-100 hover:bg-zinc-200 transition-colors ease-in-out duration-200 mb-1"
